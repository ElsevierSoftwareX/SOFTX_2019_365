...
def StressVectorsComputation(NumberOfNodes, DirectionVectors, TransverseDirVectors, NforceDef, TforceDef,
    ...
    for i in range(len(TransverseDirVectors)):
        ...
        for j in range(4):
            StressVector1[0][j] += DirectionVectors[i][0]*DeltaPerVect1[i]*NormalForceF[i][j] + TransverseDirVectors[i][0]*DeltaPerVect1[i]*ShearForceF[i][j]
            StressVector1[1][j] += DirectionVectors[i][1]*DeltaPerVect1[i]*NormalForceF[i][j] + TransverseDirVectors[i][1]*DeltaPerVect1[i]*ShearForceF[i][j]
            StressVector2[0][j] += DirectionVectors[i][0]*DeltaPerVect2[i]*NormalForceF[i][j] + TransverseDirVectors[i][0]*DeltaPerVect2[i]*ShearForceF[i][j]
            StressVector2[1][j] += DirectionVectors[i][1]*DeltaPerVect2[i]*NormalForceF[i][j] + TransverseDirVectors[i][1]*DeltaPerVect2[i]*ShearForceF[i][j]
